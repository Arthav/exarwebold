          ...
          <h2>Data agen: {{$user->name}}</h2>
            ...
            <div id="hapus01" class="w3-modal">
              <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px" >
                ...
                <form class="w3-container" action="{{ route('Human.Agen.Hapus',['id' => $user->id]) }}" method="post">
                  <div class="w3-section">
                    
                    <!-- POP UP DELETE -->
                    <div style="color:black">
                      <h3>Apakah anda yakin untuk menghapus data agen {{ $user->nama }}?</h3>
                    </div>
            ...
            <div id="edit01" class="w3-modal">
              <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px" >
                ...
                <form class="w3-container" action="{{ route('Human.Agen.Edit', ['id' => $user->id]) }}" method="post">
                  <div class="w3-section">
                    ...
                    <input class="w3-input w3-border w3-margin-bottom" type="text" value="{{ $user->nama}}" name="nama" >

                     <!-- Jabatan -->
                     <div style="color:black">
                        <label><b>Tanggal Lahir</b></label>
                     </div>
                     <input class="w3-input w3-border" type="date" value="{{ $user->email }}" name="email" >
                    ...
                    <input class="w3-input w3-border" type="date" value="{{ $user->email }}" name="email" >
                     ...
                     <input class="w3-input w3-border" type="date" value="{{ $user->alamat }}" name="alamat" >

                     <!-- NO TELEPON -->
                    <div style="color:black">
                      <label><b>No. Telepon 1</b></label>
                    </div>
                    <input class="w3-input w3-border" type="text" name="telp1" value="{{$user->telp1}}">
                    <br>
                    <div style="color:black">
                      <label><b>No. Telepon 2</b></label>
                    </div>
                    <input class="w3-input w3-border" type="text"  name="telp2" value="{{$user->telp2}}">

                    <!-- NIK -->
                    <div style="color:black">
                      <label><b>NIK</b></label>
                    </div>
                    <input class="w3-input w3-border" type="text" name="nik" value="{{ $user->nik }}">
                    <br>
                    ...
                    <input class="w3-input w3-border" type="text" name="npwp" value="{{ $user->npwp }}">
                    <br>
                    ...
                    <select class="w3-select w3-border" name="jeniskelamin">
                      @if (empty($user->jeniskelamin))
                        <option value="" disabled selected>Jenis Kelamin</option>
                      @endif
                      <option @if ($user->jenis_kelamin == 'Wanita') selected @endif value="Perempuan">Wanita</option>
                      <option @if ($user->jenis_kelamin == 'Pria') selected @endif value="Laki-laki">Pria</option>
                    </select>
                    </p>
                    ...
                    <select class="w3-select w3-border" name="agama">
                      ...
                      <option @if ($user->agama == 'Kristen') selected @endif value="Kristen">Kristen</option>
                      <option @if ($user->agama == 'Katholik') selected @endif value="Katholik">Katholik</option>
                      <option @if ($user->agama == 'Hindu') selected @endif value="Hindu">Hindu</option>
                      <option @if ($user->agama == 'Buddha') selected @endif value="Buddha">Budha</option>
                      <option @if ($user->agama == 'Lainnya') selected @endif value="Lainnya">Lainnya</option>
                    </select>
                    </p>
